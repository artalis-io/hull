...
# + cap_mysql_transport.o + cap_mysqlwire.o, defining hl_db_backend_mysql) into ONE
...
# cap_mysql_transport.o additionally references Keel (KlConnectOp + KlEventCtx for
# the connect race), likewise resolved from the base at compose. Native only.
...
$(BUILDDIR)/libhull_feature-mysql.a: $(BUILDDIR)/cap_db_mysql.o $(BUILDDIR)/cap_mysql_conn.o $(BUILDDIR)/cap_mysql_transport.o $(BUILDDIR)/cap_mysqlwire.o | $(BUILDDIR)
	@rm -f $@
	$(AR) rcs $@ $(BUILDDIR)/cap_db_mysql.o $(BUILDDIR)/cap_mysql_conn.o $(BUILDDIR)/cap_mysql_transport.o $(BUILDDIR)/cap_mysqlwire.o
