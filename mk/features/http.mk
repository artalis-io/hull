...
# both runtimes through the cap layer. The runtime core is already routed
...
# separate per-runtime archive. Keel is linked separately (the app
...
# Per-runtime web bindings (issue #114). This is the same set the
...
#
# The per-runtime web bindings are embedded here too, so a full-flavor
