// test_csp.js. Tests for hull:web:middleware:csp
//
// Lua parity: same coverage as stdlib/lua/hull/web/middleware/tests/test_csp.lua.
...
print(`hull:web:middleware:csp: ${pass} passed, ${fail} failed`);
