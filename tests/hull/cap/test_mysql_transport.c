/*
 * test_mysql_transport.c - Focused contract tests for the shared SQL-wire transport
 * (cap/db_transport.c) driven through the MySQL seam. Retained as an independent
