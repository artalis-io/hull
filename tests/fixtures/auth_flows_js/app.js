// Auth-flows e2e fixture (JS). Mirror of the Lua fixture; same
// routes, same debug endpoints. See tests/fixtures/auth_flows_lua/
// app.lua for the design notes.
